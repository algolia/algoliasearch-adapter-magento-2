    ...
    public function getCommentText($elementString): string
    {
        ...
        return <<<COMMENT
            ...
            <div class="algolia_dashboard_warning">
                <p>Backend rendering requires the Magento search engine to be set to <strong>Algolia Backend Search</strong>.</p>
                <p>You can configure this in: <a href="$link">Stores &gt; Configuration &gt; Catalog &gt; Catalog &gt; Catalog Search</a></p>
            </div>
        COMMENT;
    }
}
